...
function Bundle() {
   ...
   // console.log("envType "+envType);
    ...
    var Bundler = browserify({
        entries: './src/html/code/index.js',
...
gulp.task('build', function () {
    Bundle()
       ...
       //     .pipe(gulpif(argv.production, rename({suffix: '.min'})))
            .pipe(gulp.dest(targetLocation+'/build'))
            .on('finish', function ( ) {
...
gulp.task('release', gulpsync.sync(['clean','build', 'copy-assets',  'copy-html' ]));
gulp.task('dev', gulpsync.sync(['clean', 'build',   'copy-assets',  'copy-html', 'watch', 'serve']));